                    ...
                    <div class="modal fade" id="hapus<?=$t->id_team?>">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <a href="<?php base_url()?>teams/deleteTeam/<?=$t->id_team?>" class="btn btn-danger">Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="tambah">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
            <form action="<?php base_url()?>teams/addTeam/" method="POST" role="form">
                <div class="form-group">
                <label for="">Team Name</label>
                ...
                <div class="form-group">
                    ...
                    <select name="conf" id="conf" class="form-control">
                    <?php foreach($conf as $c):?>
                    <option value="<?=$c->id_conf?>"><?=$c->conference?></option>
                <?php endforeach?>
                </select>
                </div>                                  
            </div>
