<div class="panel panel-headline">
    ...
    <a class="btn btn-info btn-square-sm" data-toggle="modal" href='#tambah' style='margin-bottom:30px'>Tambah</a>  
		<table class="table table-striped datatabel">
            ...
            <tbody>
                                ...
                                <div class="modal-body">                                 
                                    ...
                                    <div class="form-group">
                                        <label for="">Abbreviation</label>
                                                <input type="text" class="form-control" id="abbr" name="abbr" value="<?=$t->abbr?>">
                                    </div>                                  
                                    <div class="form-group">
                ...
                <tr>
                    <td colspan=6><center>Data Tidak Ditemukan</td>
                </tr>
                <?php };?>
            </tbody>
        </table>
        ...
        <div class="modal-content">
            ...
            <form action="<?php base_url()?>teams/addTeam/<?=$t->id_team?>" method="POST" role="form">
                ...
                <div class="form-group">
                    ...
                    <select name="conf" id="conf" class="form-control">
                    <?php foreach($conf as $c):?>
                    <option value="<?=$c->id_conf?>" <?php if($c->id_conf == $t->id_conf){echo "Selected";}?>><?=$c->daya?></option>
                <?php endforeach?>
                </select>
                </div>                                  
            </div>
