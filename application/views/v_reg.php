				...
				<div class="auth-box ">
					<div class="left">
						<div class="content" style="width:90%">
                            ...
                            <?php endif?>
							<form class="form-auth-small" action="<?=base_url()?>index.php/user/register" method="POST">
								...
								<div class="bottom">
									<span class="helper-text">Already have an account?<a href="<?=base_url()?>index.php/user/login">  Login</a></span>
								</div>
							</form>
						</div>
					</div>
